...
def genai2():
    ...
    prompt = request.json.get('question1')+'Hey from the given text extract the product name product price product discount product link and product image in json format and return the json format only.'
